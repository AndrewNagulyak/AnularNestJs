...
export class BoardsController {
 ...
 @Get()
 async index(@Request() request, @GetUser() user: User,
 ): Promise<Pagination<Board>> {
	return await this.boardsService.paginate({
 ...
 @Get('/last')
 async getLast(@Request() request, @GetUser() user: User,
 ): Promise<Board[]> {
	return await this.boardsService.getLastBoards(user);
 }
